          ...
          <td
            ...
            className={`w-7/8 ${
              ...
              semScheds[day].some((schedule) => {
                ...
                ? "border-r border-black" // No border when cell is not empty
  ...
  return (
    <>
      <table className="bg-white text-black w-818 h-729 table-fixed border-b border-r border-black">
        ...
        <thead>
          <tr>
            <th className="border-b-2 border-enamelled-jewel text-enamelled-jewel font-extrabold w-32">
              Time
            </th>
            {daysOfWeek.map((day, index) => (
              <th
                key={index}
                className="border-b-2 border-enamelled-jewel text-enamelled-jewel font-extrabold"
              >
                {day}
              </th>
            ))}
