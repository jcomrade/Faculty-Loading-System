...
const AlphaListModal = ({onClose, isOpen}) => {
    ...
    return (
        <Modal isOpen={isOpen} size={'3xl'} onClose={onClose} isCentered>
            ...
            <ModalContent style={{ border: '2px solid #035C65', borderColor: '#035C65' }}>
                <h1 className='text-5xl text-enamelled-jewel font-bold bg-placebo-turquoise border-b-2 mb-4 border-enamelled-jewel rounded-tl-md rounded-tr-md pl-5 py-2'>Alpha List</h1>
                ...
                <ModalBody>
                    <p>Welcome to the Alpha List section of the user manual for our application.</p>
